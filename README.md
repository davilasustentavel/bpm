...
Abra o arquivo `index.html` diretamente no navegador ou sirva a pasta por qualquer servidor web estático. O sistema se conecta automaticamente ao banco de dados em nuvem (Supabase) e exibe os dados em tempo real.
